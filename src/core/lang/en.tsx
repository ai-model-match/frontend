export const enTranslations = {
    ...
    deleteUsecaseDescription: "Are you sure you want to delete this use case? This will permanently remove all its steps, flows, and statistics."
};