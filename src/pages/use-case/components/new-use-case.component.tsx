...
import { callCreateUseCaseApi, useCaseDto } from '../use-case.api';

interface NewUseCaseComponentProps {
  onUseCaseCreated: (useCase: useCaseDto) => void;
}
export default function NewUseCaseComponent({ onUseCaseCreated }: NewUseCaseComponentProps) {
  // Services
