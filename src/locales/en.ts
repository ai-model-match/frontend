export const enTranslations = {
  ...
  useCaseFlowsAction: 'Go to Execution Flows',
  useCaseFlowsBackAction: 'Go back to Execution Flows',
  ...
  deleteUseCaseDescription:
    'Are you sure you want to delete this Use Case? This will permanently delete all its Steps, Execution Flows, and Statistics.',
  ...
  deleteUsecaseStepDescription:
    'Are you sure you want to delete this Step? Execution Flows and statistics will be affected and incoming requests will no longer be processed by this Step.',
  ...
  updateUseCaseStepNotAllowedDescription:
    'You cannot activate this Use Case because there isn’t any active Execution Flow associated with it to handle incoming traffic. Please create or activate an Execution Flow and try again.',
  updateUseCaseStepCodeWarning:
    'Changing the ’Slug’ field may affect the proper functioning of active Execution Flows linked to this Use Case.',
  deleteUseCaseStepCodeWarning:
    'Deleting the Step may affect the proper functioning of active Execution Flows linked to this Use Case.',
  flowActiveTitlePage: 'CANDIDATE FLOWS',
  flowInactiveTitlePage: 'AVAILABLE FLOWS',
  ...
  deleteFlowTitle: 'DELETE EXECUTION FLOW',
  deleteFlowDescription:
    'Are you sure you want to delete this Execution Flow? This will permanently remove all its steps and statistics.',
  updateFlowTitle: 'UPDATE THE EXECUTION FLOW',
  updateFlowTitleInput: 'Title',
  updateFlowTitleInputPlaceholder: 'Type a title',
  updateFlowDescriptionInput: 'Description',
  updateFlowDescriptionInputPlaceholder: 'Type the description of this Execution Flow',
  updateFlowCreateBtn: 'UPDATE',
  updateFlowPctAlert:
    'Updating this percentage may change the percentages of other active Execution Flows to ensure 100% coverage of requests.',
  flowCreateNewTitle: 'Create the first Execution Flow!',
  flowCreateNewText:
    'An Execution Flow defines the concrete implementation of a Use Case, specifying for each Step the prompt, model, and parameters needed to achieve the goal.',
  ...
  newFlowDescriptionInputPlaceholder:
    'Describe the implementation of this Execution Flow',
  newFlowCreateBtn: 'CREATE',
  flowNewCardBtn: 'Create a new Execution Flow',
  activateFlowTitle: 'PROMOTE TO CANDIDATE',
  activateFlowDescription:
    'Are you sure you want to activate this Execution Flow? This will allow all its Steps to process incoming requests.',
  deactivateFlowTitle: 'REMOVE FROM CANDIDATES',
  deactivateFlowDescription:
    'Are you sure you want to deactivate this Execution Flow? This will prevent all its Steps from processing incoming requests. Others Execution Flows will be adapted to cover the 100% of incoming traffic.',
  deactivateFlowNotAllowed: 'The Execution Flow cannot be deactivated',
  deactivateFlowNotAllowedDescription:
    'You cannot deactivate the last active Execution Flow when the Use Case is active. Activate or create another Execution Flow before deactivating this one or deactivate the Use Case.',
  ...
  rsWarmupStart: 'Start adding an Execution Flow to the Warmup phase',
  rsWarmupFlowError: 'The sum of the targets must be 100%',
  rsWarmupFlowSelect: 'Select an Execution Flow',
  rsWarmupFlowSelectNothingFound: 'No Execution Flows available',
  rsWarmupFlowNotExist: 'Flow not available anymore',
